...
if(isset($_GET['proizvodjac'])) {
	$manufacturer = $_GET['proizvodjac'];
} else {
	die('Error loading the page');
}
  ...
  <!--<![endif]-->
	...
	<div class="content">
		<div class="main-content">
			...
			<?php
				$cars = $db->carsByManufacturer($manufacturer);
				if($cars === False) {
					die($db->error());
				}
						...
						echo '<div class="row" style="height: 100%; overflow:auto;">';
							echo '<div class="col-sm-6 col-md-6">';
								echo '<div class="panel panel-default">';
									echo '<a href="#" class="panel-heading no-collapse">'.strtoupper($car['proizvodjac']).'</a>';
