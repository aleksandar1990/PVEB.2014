...
<body class=" theme-blue">
  ...
  <!--<![endif]-->
	...
	<div class="panel panel-default">
			...
			echo '<a href="#" class="panel-heading no-collapse">BUY A CAR</a>';
			echo '<div id="widget2container" class="panel-body collapse in">';
				echo 'Please confirm that you are putting a reservation on '.strtoupper($details['proizvodjac']).' '.strtoupper($details['model']).'.';
				echo '<br /><br /><br />';
				?>

				<?php 
				echo '<form id="form-confirm" action="buy_confirm.php" method="POST">';
				echo '<input id="form-confirm" type="hidden" name="br_sasije" value="'.$details['br_sasije'].'"/>';
				echo '</form>';
			?>
			<a class="btn btn-primary btn-buy" onclick="document.getElementById('form-confirm').submit(); return false;">Confirm</a>
			</div>
	</div>
	</div>
	</div>
...
<!--
            <footer>
                ...
                <p>© 2015 <a href="http://www.math.rs" target="_blank">Matematicki fakultet</a></p>
            </footer>
-->			
        </div>
    </div>
