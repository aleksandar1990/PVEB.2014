...
<body class=" theme-5">
    ...
    <script language="javascript" type="text/javascript">
	  ...
	  function loadajax(){
              $("#repair").html("");
		$('#repair').show(1050).delay(3000).hide(1050);
		$.ajax({  
		  type: "GET",
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
       ...
       <li><a href="#" data-target=".legal-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-legal"></i> Cars<i class="fa fa-collapse"></i></a></li>
        <li><ul class="legal-menu nav nav-list collapse">
            ...
            <li class="active"><a href="repear.php"><span class="fa fa-caret-right"></span>Car repair</a></li>
  ...
  <div id="form-div">
	...
	?>
	  ...
	  <div class="panel panel-default">
        <a href="#page-stats" class="panel-heading" data-toggle="collapse">Enter repaired car</a>
        <div id="page-stats" class="panel-collapse panel-body collapse in">
      <div id="form-main">
  <div id="form-div">
    <form class="form" id="form2" method="post"  action="#" >
      ...
      <p class="name">
        <input name="ID_sasije" type="text" class="validate[required,length[1,100]] feedback-input" placeholder="Chassis number" id="name" pattern="(\w|\d){15}" title="Please enter chassis number e.g. 58x7K68k44629pD" required>
      </p>
      <!-- input ID_popravio korisnika iz baze koji je ulogovan-->
      
      <p class="text" >
        <input type="hidden" name="ID_popravio" value="<?php echo $_SESSION['id'] ?>" readonly="readonly">
      </p>
      
      <p class="text">
          <textarea name="Opis_popravke" type="text" class="validate[required,length[6,500]] feedback-input" id="name" placeholder="Description of repairs" required></textarea>
      </p>
      ...
      <p class="text">
        <input name="Cena_delova" class="validate[required,length[6,300]] feedback-input" id="name" placeholder="Repair costs" pattern="\d+" title="Please enter cost" required>
      </p>
	  <p class="text">
          <textarea name="Opis_kvara" type="text" class="validate[required,length[6,500]] feedback-input" id="name" placeholder="Description of failure" required></textarea>
      </p>
      <p class="text">
          <textarea name="Opis_stanja" type="text" class="validate[required,length[6,500]] feedback-input" id="name" placeholder="Description of the current state of the car" required></textarea>
      </p>
      ...
      <div class="submit">
          <input type="submit" name="submit2" value="Enter repaired car" id="button-blue"/>
        <div class="ease"></div>
      </div>
    </form>
  </div>
	...
	<?php
			   ...
			   {
                                 if ($dbManager->proveriSasijupopravka()==FALSE)
                                 {
								echo(' <div class="alert alert-error">
											<button type="button" class="close" data-dismiss="alert">×</button>
											The car with this Chassis number is not exists in database as broken!
										 </div>');
								}
								else{
				  $dbManager->PopravkamalFunction(); //UPDATE `kvarovi`
                                 echo(' <div class="alert alert-success">
											<button type="button" class="close" data-dismiss="alert">×</button>
											Repaired car is successfully entered in database.
										 </div>');
                                    }
			   }
