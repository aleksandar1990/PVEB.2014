...
<body class=" theme-5">
    ...
    <script language="javascript" type="text/javascript">
	  ...
	  function loadajax(){
		...
		$.ajax({  
		  type: "GET",
		  url: '../DBManager/listIznajmljeniJSON.php',    		        
		  data: "",   											
		  dataType: 'json', 		  
	  ...
	  function drawTable(data) {
		...
		function drawRow(rowData) {
			...
			row.append($("<td>" + rowData.ID_korisnika + "</td>"));
                        row.append($("<td>" + rowData.Ime_korisnika + "</td>"));
			row.append($("<td>" + rowData.Proizvodjac + "</td>"));
			row.append($("<td>" + rowData.Model + "</td>"));
			row.append($("<td>" + rowData.Br_ugovora + "</td>"));
			row.append($("<td>" + rowData.Datum_iznajmljivanja + "</td>"));
			row.append($("<td>" + rowData.Ugovoreni_datum_vracanja + "</td>"));
		}
  ...
  <!--<![endif]-->
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
            ...
            <li class="active"><a href="return.php"><span class="fa fa-caret-right"></span>Returning the car</a></li>
    ...
    <div class="content">
	  ...
	  <?php
			...
			$dbManager = DBManager::getInstance();
			   ...
			   {
                                 if ($dbManager->chachIznajmljen()==FALSE)
                                 {
						echo(' <div class="alert alert-error">
									<button type="button" class="close" data-dismiss="alert">×</button>
									The car with this Chassis number is not exists in database as rented!
								 </div>');
                                  }
                                  elseif ($dbManager->chachUgovoriBRsasije()==FALSE)
                                 {
						echo(' <div class="alert alert-error">
									<button type="button" class="close" data-dismiss="alert">×</button>
									The car with this Chassis number is not reted with that number of contract!
								 </div>');
                                  }
                                        else{
				  $dbManager->returnUpdate();
	...
	?>
		...
		<a href="#page-stats" class="panel-heading" data-toggle="collapse">Returning the car</a>
  ...
  <div id="form-div">
    <form class="form" id="form1" method="post">
      ...
      <div class="submit">
        <input type="submit" name="submit" value="Return the car" id="button-blue"/>
        <div class="ease"></div>
      </div>
    </form>
  </div>
...
<div class="row">
   <div class="tabela1" style="width: 100; padding-left: 15px; padding-right: 15px">
        <div class="panel panel-default">
            <div class="panel-heading no-collapse">Rented Cars</div>
            <table class="table table-bordered table-striped">
              <thead>
                <tr>
				  ...
				  <th>The agreed date of returning</th>
