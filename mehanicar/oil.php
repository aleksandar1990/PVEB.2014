...
<body class=" theme-5">
    ...
    <script language="javascript" type="text/javascript">
	  ...
	  function drawTable(data) {
		...
		function drawRow(rowData) {
			...
			row.append($("<td>" + rowData.BRsasije + "</td>")); 
			row.append($("<td>" + rowData.Ime + "</td>"));		
			row.append($("<td>" + rowData.Datum_promene + "</td>"));
            row.append($("<td>" + rowData.Oil_type + "</td>"));
  ...
  <!--<![endif]-->
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
       ...
       <li><a href="#" data-target=".legal-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-legal"></i> Cars<i class="fa fa-collapse"></i></a></li>
        <li><ul class="legal-menu nav nav-list collapse">
            ...
            <li class="active"><a href="oil.php"><span class="fa fa-caret-right"></span> Oil change</a></li>
	...
	<?php
			...
			$dbManager = DBManager::getInstance();
			   ...
			   {
                                 if ($dbManager->proveriSasiju()==FALSE)
                                 {
						echo(' <div class="alert alert-error">
									<button type="button" class="close" data-dismiss="alert">×</button>
									The car with this Chassis number is not exists in database!
								 </div>');
                                  }
                                  elseif ($dbManager->proveriKilometre()==FALSE)
                                 {
						echo(' <div class="alert alert-error">
									<button type="button" class="close" data-dismiss="alert">×</button>
									Mileage is not correct!
								 </div>');
                                  }
                                        else{
				  $dbManager->OilInsert();
   ...
   <div class="panel panel-default">
        <a href="#page-stats" class="panel-heading" data-toggle="collapse">Change oil</a>
  ...
  <div id="form-div">
    <form class="form" id="form1" method="post">
      ...
      <p class="name">
        <input name="chassis_num" type="text" class="validate[required,length[1,100]] feedback-input" placeholder="Chassis Number" id="name" pattern="(\w|\d){15}" required>
      </p>
      ...
      <p class="text">
          <input name="tip_ulja" type="text" class="validate[required,length[2,500]] feedback-input" id="name" placeholder="Oil type" required>
      </p>
      
      <p class="text" >
        <input type="hidden" name="datum_promene_ulja" value="<?php echo date('Y-m-d'); ?>" readonly="readonly">
      </p>
     
      <p class="text">
          <input name="current_mileage" type="text" class="validate[required,length[6,500]] feedback-input" id="name" placeholder="Current mileage" pattern="\d+" required>
      </p>
      
      <div class="submit">
          <input type="submit" name="submit" value="Change oil" id="button-blue"/>
        <div class="ease"></div>
      </div>
    </form>
  </div>
...
<div class="row">
   <div class="tabela1" style="width: 100%; padding-left: 15px; padding-right: 15px">
        <div class="panel panel-default">
            <div class="panel-heading no-collapse">Change Oil History</div>
