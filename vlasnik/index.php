...
<body class=" theme-blue">
  ...
  <!--<![endif]-->
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
            <li class="active"><a href="index.php"><span class="fa fa-caret-right"></span> Home</a></li>
...
$('#hideee').show(0).delay(3000).hide(1000);

});

</script>
<div class="alert alert-success" id="hideee">
			<button type="button" class="close" data-dismiss="alert">×</button>
			<?php echo $korisnik['ime'] ?> is now successfully logged in as Owner.
		</div>
...
<div class="row">
   <div class="tabela1" style="width: 100; padding-left: 15px; padding-right: 15px">
        <div class="panel panel-default">
            <div class="panel-heading no-collapse">Available Cars</div>
