...
<html lang="en"><head>
	...
	<script language="javascript" type="text/javascript">
	  ...
	  function loadajax(){
		...
		$.ajax({  
		  type: "GET",
		  url: '../DBManager/listTransactionsJSON.php',    		        
		  data: "",   											
		  dataType: 'json', 		  
	  ...
	  function drawTable(data) {
		...
		function drawRow(rowData) {
			var row = $("<tr />")
			$("tbody").append(row); 
			row.append($("<td>" + rowData.id_transakcije + "</td>"));
			row.append($("<td>" + rowData.Ime + "</td>"));
			row.append($("<td>" + rowData.Prezime + "</td>"));
			row.append($("<td>" + rowData.datum_transakcije + "</td>"));
			row.append($("<td>" + rowData.opis_transakcije + "</td>"));
  ...
  <!--<![endif]-->
	...
	<li><a href="users.php" class="nav-header"><i class="fa fa-fw fa-briefcase"></i> User accounts</a></li>
        ...
        <li><ul class="legal-menu nav nav-list collapse">
            ...
            <li class="active"><a href="transakcije.php"><span class="fa fa-caret-right"></span> Transactions</a></li>
    </ul></li>
